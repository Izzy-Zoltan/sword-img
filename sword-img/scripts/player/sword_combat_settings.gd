...
@export var neutral_rotation: Vector2 = Vector2.ZERO
...
@export var slash_afterimage_lifetime: float = 0.14
@export var slash_afterimage_alpha: float = 0.42
@export var slash_strike_time: float = 0.11
@export var slash_settle_time: float = 0.08
@export var slash_recover_time: float = 0.22
